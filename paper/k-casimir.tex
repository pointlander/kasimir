...
\item \emph{Interacting analog systems.} Can a \(1{+}1\) CFT engine (e.g. a quantum wire or a trapped Tonks gas between movable barriers) measure the \(1/24\)-nat invariant independently of the conversion scale, by varying \(a\) and \(c_{\mathrm{CFT}}\) separately, and see the DN sign flip?
